...
contract Ecio3CommonWarriorsCollection is EcioChallenge, ECIOHelper, Ownable{
    ...
    {
        return
            compareStrings(headCode, "00") ||
            compareStrings(headCode, "01") ||
            compareStrings(headCode, "02") ||
            compareStrings(headCode, "03") ||
            compareStrings(headCode, "04") ||
            compareStrings(headCode, "05") ||
            compareStrings(headCode, "06");
    }
